	...
	tinymce.create('tinymce.plugins.scabnPlugin',
		{init:function(ed,url)
			{ed.addCommand('mcescabn',function()
				...
				ed.addButton('scabn',{title:'Add SCABN Item or Checkout',cmd:'mcescabn',image:url+'/img/scabn.png'});ed.onNodeChange.add(function(ed,cm,n){cm.setActive('scabn',n.nodeName=='IMG')})},
